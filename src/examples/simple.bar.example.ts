...
bar.add(
  new BarItem([p, new Progress({ total: 100, start: 50, tag: 'red' }), p], {
...
// use presets
bar.add(
  new BarItem([new Progress({ total: 100, start: 33 })], {
    options: presets.rect,
  }),
);

bar.add(
  new BarItem([new Progress({ total: 100, start: 77 })], {
    options: presets.shades,
  }),
);
