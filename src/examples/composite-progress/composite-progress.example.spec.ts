...
describe('CompositeProgressComponent', () => {
  ...
  it('one by few', () => {
    ...
    const calls = terminalMock.write.mock.calls.map(call => call[0]);
    expect(calls).toMatchObject([
      '[00000111░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░] 1300 (2000) total: 10000 13% (20%) ETA: ∞ (∞)\n',
      '[0000000001111111░░░░░░░░░░░░░░░░░░░░░░░░] 2300 (4000) total: 10000 23% (40%) ETA: 4s (2s)\n',
      '[000000000000011111111111░░░░░░░░░░░░░░░░] 3300 (6000) total: 10000 33% (60%) ETA: 5s (1s)\n',
      '[00000000000000000111111111111111░░░░░░░░] 4300 (8000) total: 10000 43% (80%) ETA: 4s (1s)\n',
      '[0000000000000000000001111111111111111111] 5300 (10000) total: 10000 53% (100%) ETA: 4s (0s)\n',
      '[0000000000000000000000000111111111111111] 6300 (10000) total: 10000 63% (100%) ETA: 3s (0s)\n',
      '[0000000000000000000000000000011111111111] 7300 (10000) total: 10000 73% (100%) ETA: 3s (0s)\n',
      '[0000000000000000000000000000000001111111] 8300 (10000) total: 10000 83% (100%) ETA: 2s (0s)\n',
      '[0000000000000000000000000000000000000111] 9300 (10000) total: 10000 93% (100%) ETA: 1s (0s)\n',
      '[0000000000000000000000000000000000000000] 10000 (10000) total: 10000 100% (100%) ETA: 0s (0s)\n',
    ]);
  });
  ...
  it('one by few2', () => {
    ...
    const calls = terminalMock.write.mock.calls.map(call => call[0]);
    expect(calls).toMatchObject([
      '[000011111░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░] 2300 (1000) total: 10000 23% (10%) ETA: ∞ (∞)\n',
      '[00000000111111111░░░░░░░░░░░░░░░░░░░░░░░] 4300 (2000) total: 10000 43% (20%) ETA: 1s (4s)\n',
      '[0000000000001111111111111░░░░░░░░░░░░░░░] 6300 (3000) total: 10000 63% (30%) ETA: 1s (5s)\n',
      '[000000000000000011111111111111111░░░░░░░] 8300 (4000) total: 10000 83% (40%) ETA: 1s (5s)\n',
      '[0000000000000000000011111111111111111111] 10000 (5000) total: 10000 100% (50%) ETA: 0s (4s)\n',
      '[0000000000000000000000001111111111111111] 10000 (6000) total: 10000 100% (60%) ETA: 0s (4s)\n',
      '[0000000000000000000000000000111111111111] 10000 (7000) total: 10000 100% (70%) ETA: 0s (3s)\n',
      '[0000000000000000000000000000000011111111] 10000 (8000) total: 10000 100% (80%) ETA: 0s (2s)\n',
      '[0000000000000000000000000000000000001111] 10000 (9000) total: 10000 100% (90%) ETA: 0s (1s)\n',
      '[0000000000000000000000000000000000000000] 10000 (10000) total: 10000 100% (100%) ETA: 0s (0s)\n',
    ]);
  });
});
