...
export class ProgressRender implements IRender {
  ...
  public static create(params: Partial<IRenderParams> = {}) {
    return new ProgressRender(params);
  }
  ...
  public constructor(params: Partial<IRenderParams> = {}) {
    this.params = ProgressRender.assignParams(params);
  }
