...
describe('Eta', () => {
  ...
  describe('should count speed based on speedMoments, deps, debounce', () => {
    ...
    it ('duration 1800, increment 10', () => {
      ...
      expect(etas.map(eta => eta.getSpeed())).toEqual([11.428571428571429, 11.428571428571429, 11.363636363636363])
    ...
    it ('duration 2500, increment 10', () => {
      ...
      expect(etas.map(eta => eta.getSpeed())).toEqual([12.61904761904762, 12.61904761904762, 12.5])
    ...
    it ('duration 2800, increment 10', () => {
      ...
      expect(etas.map(eta => eta.getSpeed())).toEqual([21.775793650793656, 21.775793650793656, 18.910256410256412])
    ...
    it ('duration 3100, increment 10', () => {
      ...
      expect(etas.map(eta => eta.getSpeed())).toEqual([28.571428571428573, 28.571428571428573, 22.61904761904762])
    ...
    it ('duration 3400, increment 10', () => {
      ...
      expect(etas.map(eta => eta.getSpeed())).toEqual([33.333333333333336, 33.333333333333336, 27.09183673469388])
    ...
    it ('duration 3750, increment 10', () => {
      ...
      expect(etas.map(eta => eta.getSpeed())).toEqual([31.34920634920635, 33.333333333333336, 29.387755102040817])
    ...
    it ('duration 5100, increment 10', () => {
      ...
      expect(etas.map(eta => eta.getSpeed())).toEqual([20.943562610229282, 20.943562610229282, 25.57823129251701,])
