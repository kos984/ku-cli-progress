...
describe('Eta', () => {
  ...
  it('should update speed, eta and duration correctly', () => {
    ...
    time.getTime.mockReturnValue(started + 1000);
    eta.update(10, 100);
    time.getTime.mockReturnValue(started + 2000);
    eta.update(20, 100);
  ...
  it('should correct handle set', () => {
    eta.set(10);
    const started = eta.started;
    time.getTime.mockReturnValue(started);
  ...
  describe('should count speed based on speedMoments, deps, debounce', () => {
    const eta = new Eta({ deps: 3, debounce: 0.01, time });
    const etaDebounce = new Eta({ deps: 3, debounce: 0.1, time });
    const etaDeps = new Eta({ deps: 5, debounce: 0.01, time });
    ...
    it('duration 1000, increment 10', () => {
      time.getTime.mockReturnValue(1000);
    ...
    it('duration 1800, increment 10', () => {
      time.getTime.mockReturnValue(1800);
    ...
    it('duration 2500, increment 10', () => {
      time.getTime.mockReturnValue(2500);
    ...
    it('duration 2800, increment 10', () => {
      time.getTime.mockReturnValue(2800);
    ...
    it('duration 3100, increment 10', () => {
      time.getTime.mockReturnValue(3100);
    ...
    it('duration 3400, increment 10', () => {
      time.getTime.mockReturnValue(3400);
    ...
    it('duration 3750, increment 10', () => {
      time.getTime.mockReturnValue(3750);
    ...
    it('duration 5100, increment 10', () => {
      time.getTime.mockReturnValue(5100);
  ...
  describe('Edge Cases (total >= count)', () => {
    beforeEach(async () => {
      eta.set(0);
      const started = eta.started;
      time.getTime.mockReturnValue(started + 9900);
      eta.update(99, 100);
      expect(eta.getSpeed()).toBe(10);
      expect(eta.getEtaS()).toBe(0);
      expect(eta.getDurationMs(9900));
      time.getTime.mockReturnValue(started + 10000);
      eta.update(100, 100);
      time.getTime.mockReturnValue(started + 11000);
